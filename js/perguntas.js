        ...
        alternativas: [
            {
                ...
                afirmacao: [
                "O cansaço é uma das causas mais alegadas por aqueles que reclamam que não conseguem estudar. Por isso, antes de desesperar-se, você já verificou se não precisa de um tempo para respirar? Anda dormindo bem? Comeu bem? Dormiu por pelo menos 6 horas? Estar descansado é essencial para uma boa absorção sobre os conteúdos."
                ],
            },
            {
                texto: "Eu deixo para trás e vou para o próximo assunto.",
                afirmacao: [
                "Às vezes só precisamos de um tempo para assimilar, passar para um próximo assunto em que tenho mais afinidade talvez ajude. E depois, com mais tempo, mais descansado e mais paciencioso consiga aprender melhor o conteúdo."
                ],
            },
        ]
    }
